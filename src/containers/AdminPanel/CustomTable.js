                                                   ...
                                                   changeId === product.id ? (
                                                    ...
                                                    <TableRow >
                                                      <div className="card__footer1">
                                                            <TableCell align="right" className="gradient-button"> <button onClick={() => deleteProduct(product.id)}>DEL</button> </TableCell>
                                                            <TableCell align="right"  className="gradient-button"> <button onClick={() => handleEditChange(product.id)}>EDIT</button> </TableCell>
                                                      </div>
